...
const skills = [
  ...
  { name: "AI / RAG Pipelines", level: 5, cat: "AI", desc: "Retrieval-augmented generation, semantic search, LLM orchestration with LangChain, embeddings, Pinecone, FAISS." },
...
const projects = [
  ...
  { label: "Online math contest platform with live leaderboards", stack: "Next.js · Node.js · PostgreSQL · AWS", type: "Web Platform" },
  ...
  { label: "Islamic finance & investment platform", stack: "Flutter · Django · PostgreSQL · Azure", type: "Fintech" },
];
      ...
      <div className="w-full bg-gradient-to-br from-emerald-600 via-teal-700 to-cyan-800 text-white">
        <div className="max-w-2xl mx-auto px-4 py-16 flex flex-col gap-5">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-emerald-200 text-sm font-medium uppercase tracking-wider">Service</p>
            ...
            {projects.map((p) => (
              <div key={p.label} className="flex flex-col gap-1.5 p-4 rounded-xl bg-white dark:bg-olive-950 border border-olive-200 dark:border-olive-800">
                <div className="flex items-start justify-between gap-2 flex-wrap">
                  ...
                  <span className={`text-[10px] px-1.5 py-0.5 rounded font-medium shrink-0 ${catColor["AI"] || "bg-olive-200 text-olive-700"} bg-sky-100 text-sky-700 dark:bg-sky-900/30 dark:text-sky-300`}>{p.type}</span>
                </div>
        ...
        <section className="flex flex-col gap-4 p-5 rounded-2xl bg-white dark:bg-olive-950 border border-olive-200 dark:border-olive-800">
          ...
          <ol className="flex flex-col gap-3">
            {[
              ...
              "Support — I&apos;m available post-launch for fixes and feature additions.",
            ].map((step, i) => (
