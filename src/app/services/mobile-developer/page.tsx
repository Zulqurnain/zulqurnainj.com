...
const appTypes = [
  { icon: "💳", label: "Fintech & Banking" },
  { icon: "🛍️", label: "E-commerce" },
  { icon: "🚗", label: "Ride-sharing & Transit" },
  { icon: "🏥", label: "Healthcare" },
  { icon: "📚", label: "EdTech" },
  { icon: "🏠", label: "Real Estate" },
  { icon: "💼", label: "Enterprise / B2B" },
      ...
      <div className="w-full bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white">
        <div className="max-w-2xl mx-auto px-4 py-16 flex flex-col gap-5">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-blue-200 text-sm font-medium uppercase tracking-wider">Service</p>
      ...
      <div className="max-w-2xl mx-auto px-4 py-12 flex flex-col gap-12">
        ...
        <section className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {appTypes.map((a) => (
              <div key={a.label} className="flex flex-col items-center gap-2 p-3 rounded-xl bg-white dark:bg-olive-950 border border-olive-200 dark:border-olive-800 text-center">
                <span className="text-2xl">{a.icon}</span>
                <span className="text-xs font-medium text-olive-700 dark:text-olive-300">{a.label}</span>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              { label: "Banking super-app with SWIFT integration", stack: "React Native · Java · Oracle DB", platform: "iOS & Android" },
