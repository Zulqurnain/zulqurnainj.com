...
# Create the subdomain (points to /home/your-cpanel-username/tools.zulqurnainj.com by default)
result = curl(
...
3. Upload `.next/standalone/` to `/home/your-cpanel-username/tools.{domain}/` via SFTP (port YOUR_SFTP_PORT)
4. Create CV storage dir: `mkdir -p /home/your-cpanel-username/tool_cvs && chmod 700 /home/your-cpanel-username/tool_cvs`
